...
(function($) {
	...
	// Menu.
		var $menu = $('#menu'),
			$menu_mydocuments = $menu.children('ul').find('.mydocuments');

		 mydocuments.
			$menu_mydocuments.each(function() {
//
				var $this = $(this);
				...
				$this.on('click', function(event) {
					...
					// Toggle.
						$menu_mydocuments.not($this).removeClass('active');
 ...
 window.onload = function () {
  ...
  carpetas.forEach(nombre => renderizarCarpeta(nombre));

  const btn = document.getElementById("crearCarpetaBtn");
  btn.addEventListener("click", crearCarpeta);
};
...
function renderizarCarpeta(nombre) {
  const contenedor = document.getElementById("carpetasContainer");
